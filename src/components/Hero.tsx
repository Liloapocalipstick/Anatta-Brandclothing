...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 left-20 w-4 h-4 bg-neon-pink rounded-full animate-pulse" />
      <div className="absolute top-40 right-32 w-6 h-6 bg-neon-green rounded-full animate-pulse delay-300" />
      <div className="absolute bottom-32 left-16 w-3 h-3 bg-neon-blue rounded-full animate-pulse delay-700" />
    </section>
  );
}